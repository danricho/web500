# OPTIONAL PUSH NOTIFICATIONS VIA AN ntfy (https://ntfy.sh/) SERVER - SELF-HOSTED OR THE
# PUBLIC ntfy.sh, NO SELF-HOST-SPECIFIC LOGIC HERE (JUST A POST TO {server}/{topic}).
...
# DEFERRED Popen IN main.py). NOTE IF POINTING AT THE PUBLIC ntfy.sh: A FREE TOPIC IS
# JUST A GUESSABLE NAME, NOT AN ACCOUNT - ANYONE WHO KNOWS/GUESSES IT CAN READ (OR POST
# TO) IT. USE AN UNGUESSABLE TOPIC OR A PAID PLAN WITH auth_token SET.
import json
import os
import threading
